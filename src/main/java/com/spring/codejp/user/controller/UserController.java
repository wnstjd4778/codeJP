...
public class UserController {
    ...
    @GetMapping("")
    public ResponseEntity<User> getMyInfo(@AuthenticationPrincipal UserPrincipal userPrincipal) throws NotFoundException {
        User user = userService.getMyInfo(userPrincipal.getUsername());
